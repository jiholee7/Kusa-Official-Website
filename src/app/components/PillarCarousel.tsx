  ...
  return (
    <section className={`bg-background py-8`} id="pricing">
      <div className={`relative container mx-auto px-2 pt-4 pb-12 text-primary`}>
        <div className='absolute top-20 text-6xl transition ease-in-out hover:scale-110 duration-200 hover:text-secondary left-0 lg:top-48 lg:left-10 cursor-pointer' onClick={nextPillar}>&#10096;</div>
        <div className='absolute text-6xl transition ease-in-out hover:scale-110 duration-200 hover:text-secondary right-0 top-20 lg:top-48 lg:right-10 cursor-pointer' onClick={prevPillar}>&#10097;</div>
        <h1
        ...
        <div
          className={`flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4 pb-12`}
        >

          <div
            className={`flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-background mt-4 cursor-pointer transition ease-in-out hover:scale-105 duration-200 hover:text-secondary`}
            onClick={nextPillar}
          >
            <div
            ...
            >
              <div className={`p-8 text-3xl font-bold text-center border-b-4 transition ease-in-out duration-200 hover:text-gray-800`}>
                {pillar==1 ? p2?.title : pillar==2 ? p3?.title : p1?.title}
              </div>
            </div>
          </div>

          <div
            className={`flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-background mt-4 sm:-mt-6 shadow-lg z-10 cursor-pointer mb-10 scale-105 transition ease-in-out hover:scale-110 duration-200 hover:text-secondary`}
          >
            <div
              className={`flex-1 bg-background rounded-t rounded-b-none overflow-hidden shadow`}
            >
              <div className={`w-full p-8 text-3xl font-bold text-center`}>
                {pillar==1 ? p1?.title : pillar==2 ? p2?.title : p3?.title}
              </div>
              <div
          ...
          <div
            className={`flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-primary mt-4 cursor-pointer transition ease-in-out hover:scale-105 duration-200 hover:text-secondary`}
            onClick={prevPillar}
          >
            <div
              className={`flex-1 bg-background text-gray-600 rounded-t rounded-b-none overflow-hidden shadow`}
            >
              <div className={`p-8 text-3xl font-bold text-center border-b-4 transition ease-in-out duration-200 hover:text-gray-800`}>
                {pillar==1 ? p3?.title : pillar==2 ? p1?.title : p2?.title}
              </div>
            </div>
          </div>
        ...
        <div>
          <div className='w-full px-16'>{pillar==1 &&
              <LazyShow>
                <>
                  <PillarCulture title={p1?.title} subtitle={p1?.subtitle} description={p1?.description} image={p1?.image}/>
                  <h1
          ...
          <div className='w-full px-16'>{pillar==2 &&
              <LazyShow>
                <>
                  <PillarCommunity title={p2?.title} subtitle={p2?.subtitle} description={p2?.description} image={p2?.image} />
                </>
              </LazyShow>
            }
          </div>
