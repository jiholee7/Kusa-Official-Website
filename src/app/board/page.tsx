  ...
  return (
    <div className={`bg-background grid gap-y-16 overflow-hidden`}>
      ...
      <div className='px-10 lg:px-24'>
        <div 
          className='grid sm:grid-cols-2 sm:gap-6 md:grid-cols-3 md:gap-6 lg:gap-8 lg:grid-cols-5'
        >
          {board.eboard.map((item) => (
            <div key={item.key} className='relative h-80 bg-red-200/50 text-xl font-bold leading-tight text-center text-secondary content-between rounded-2xl transition ease-in-out hover:scale-110 duration-250'>
